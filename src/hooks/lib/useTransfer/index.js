...
var useTransfer = function useTransfer(dataSource) {
  ...
  var _useState5 = (0, _react.useState)(defaultDisabled),
      _useState6 = _slicedToArray(_useState5, 2),
      disabled = _useState6[0],
      setDisabled = _useState6[1];

  var _useState7 = (0, _react.useState)(deafultShowSearch),
      _useState8 = _slicedToArray(_useState7, 2),
      showSearch = _useState8[0],
      setShowSearch = _useState8[1];

  var noTargetKeys = (0, _react.useMemo)(function () {
  ...
  var unSelectedKeys = (0, _react.useMemo)(function () {
    return dataSource.filter(function (d) {
  ...
  var handleChange = (0, _react.useCallback)(function (nextTargetKeys, direction, moveKeys) {
  ...
  var handleSelectChange = (0, _react.useCallback)(function (sourceSelectedKeys, targetSelectedKeys) {
