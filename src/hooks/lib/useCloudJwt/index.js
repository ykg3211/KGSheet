...
exports.default = exports.JWT_URL = exports.JWT_KEY = void 0;
...
var JWT_KEY = '__byted_hook_jwt';
exports.JWT_KEY = JWT_KEY;
var JWT_URL = 'https://cloud.bytedance.net/auth/api/v1/jwt';
exports.JWT_URL = JWT_URL;
...
var useCloudJwt = function useCloudJwt() {
  ...
  var _useState = (0, _react.useState)(initToken),
      _useState2 = _slicedToArray(_useState, 2),
      token = _useState2[0],
      setToken = _useState2[1];

  var mounting = useMounting();
  var refreshJwt = (0, _react.useCallback)(function () {
