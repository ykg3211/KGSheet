...
var useServiceTree = function useServiceTree() {
  ...
  var _useCloudJwt = (0, _useCloudJwt3.default)(jwtToken),
      _useCloudJwt2 = _slicedToArray(_useCloudJwt, 1),
      token = _useCloudJwt2[0];

  var treeIdKeys = (0, _react.useMemo)(function () {
    return Array.from(dataMapRef.current.keys()).map(String);
  }, [dataMapRef.current]);
  var checkedSelect = (0, _useMultiSelect.default)(treeIdKeys);
  var selectedSelect = (0, _useMultiSelect.default)(treeIdKeys);
  var expandedSelect = (0, _useMultiSelect.default)(treeIdKeys);
  var fetchWithJwt = (0, _react.useCallback)(_async(function (url) {
    var options = {
      headers: {
        'X-Jwt-Token': token
      },
