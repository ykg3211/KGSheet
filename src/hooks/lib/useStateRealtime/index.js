...
function useStateRealtime(initVal) {
  ...
  var valRef = (0, _react.useRef)(initState);
  var setState = (0, _react.useCallback)(function (newVal) {
    var newState = getStateVal(valRef.current, newVal);
    valRef.current = newState;
    setVal(newState);
  }, []);
  var getRealState = (0, _react.useCallback)(function () {
    return valRef.current;
  }, []);
  return [val, setState, getRealState];
}

var _default = useStateRealtime;
