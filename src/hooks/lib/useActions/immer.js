...
exports.useActionsExtension = useActionsExtension;
...
function useActionsExtension(reducers, setState) {
...
function useActions(reducers, initialState) {
  var _useImmerState = (0, _useImmer.useImmerState)(initialState),
