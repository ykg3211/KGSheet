...
function useLoadMore(requestFn) {
  ...
  var result = useBaseRequest(requestFn, _objectSpread(_objectSpread({}, restOptions), {}, {
    ready: ready,
    auto: auto,
  ...
  var getParams = useCallback(function () {
    // id 模式下读取 Key
