import TimeStampedSet from './timeStampedSet';
...
export var postChannelMessage = _async(function (channel, messageJson) {
...
export var createChannel = _async(function (channelName) {
  ...
  return _call(dbPromise, function (db) {
    var channel = {
      ...
      closed: false,
      lastCursorId: 0,
      emittedMessages: new TimeStampedSet(1000 * 45 * 2),
...
export var deleteExpiredMessages = _async(function (db, expireTime) {
...
export function writeMessagesToDB(channel, messageJson) {
  var db = channel.db,
...
export function readMessagesFromDB(channel) {
  var db = channel.db,
...
export function readMessagesByTime(db, expireTime) {
...
export function onChannelMessage(channel, fn, timeStamp) {
